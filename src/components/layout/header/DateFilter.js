  ...
  const handleChangeOptions = (v) => {
    ...
    switch (true) {
      ...
      case v.target.value === "nextweek":
        ...
        const formattedNextWeek = nextweeknumber.toString().padStart(2, "0"); // Agrega un 0 si el número es menor a 10
        const nextyearnumber = moment().year();
        const nextcurrentWeek = `${nextyearnumber}${formattedNextWeek}`;
